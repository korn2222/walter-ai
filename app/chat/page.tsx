                ...
                <div className="absolute bottom-4 w-full z-20 p-2 bg-transparent">
                    <form onSubmit={sendMessage} className="max-w-2xl mx-auto relative flex items-center">
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-slate-700 hover:bg-slate-600 text-white p-2 rounded-full transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-glow hover:scale-105 active:scale-95 shadow-lg"
                        >
                            <Send size={20} />
                        </button>
                    </form>
